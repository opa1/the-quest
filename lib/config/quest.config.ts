...
export const QUEST_CONFIG = {
  ...
  postMission: {
    ...
    form: {
      ...
      descriptionPlaceholder: 'Describe the mission in detail. What needs to be done? What does success look like?',
    ...
    difficultyCredits: {
      easy:   { credits: 400,  label: 'Easy',   description: 'Quick tasks, clear scope' },
      medium: { credits: 1200, label: 'Medium',  description: 'Moderate effort required' },
      hard:   { credits: 3000, label: 'Hard',    description: 'Complex, high skill needed' },
    },
    previewTab:     'PREVIEW',
    formTab:        'FORM',
  ...
  submitProof: {
    ...
    notesLabel:           'Notes',
    notesPlaceholder:     'Describe what you did and how it meets the mission requirements...',
  ...
  reviewPanel: {
    ...
    banConfirmDescription:    'This user will no longer be able to claim this mission.',
